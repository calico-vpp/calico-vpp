...
func (AddPathMode) EnumDescriptor() ([]byte, []int) { return fileDescriptorCapability, []int{0} }
...
func (*MultiProtocolCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{0}
}
...
func (*RouteRefreshCapability) Descriptor() ([]byte, []int) { return fileDescriptorCapability, []int{1} }
...
func (*CarryingLabelInfoCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{2}
}
...
func (*ExtendedNexthopCapabilityTuple) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{3}
}
...
func (*ExtendedNexthopCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{4}
}
...
func (*GracefulRestartCapabilityTuple) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{5}
}
...
func (*GracefulRestartCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{6}
}
...
func (*FourOctetASNumberCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{7}
}
...
func (*AddPathCapabilityTuple) Descriptor() ([]byte, []int) { return fileDescriptorCapability, []int{8} }
...
func (*AddPathCapability) Descriptor() ([]byte, []int) { return fileDescriptorCapability, []int{9} }
...
func (*EnhancedRouteRefreshCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{10}
}
...
func (*LongLivedGracefulRestartCapabilityTuple) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{11}
}
...
func (*LongLivedGracefulRestartCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{12}
}
...
func (*RouteRefreshCiscoCapability) Descriptor() ([]byte, []int) {
	return fileDescriptorCapability, []int{13}
}
...
func (*UnknownCapability) Descriptor() ([]byte, []int) { return fileDescriptorCapability, []int{14} }
...
func init() { proto.RegisterFile("capability.proto", fileDescriptorCapability) }

var fileDescriptorCapability = []byte{
